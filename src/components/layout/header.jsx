import { Star, Sun, TrendingUp ,Moon} from "lucide-react"
...
const Header = () => {
  ...
  return <header className="bg-white shadow-sm border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700">
    <div className="container">
      <div className="flex justify-between items-center py-4">
        ...
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h1 className="text-xl font-vold text-gray-900 dark:text-white ">Udemig Tracker</h1>
        ...
        <div className="flex items-center space-x-4">
          ...
          className="p-2 rounded-lg bg-gray-100 hover:bg-gray-200 transition dark:bg-gray-700 dark:hover:bg-gray-00">
