...
const CoinChartSection = ({coin,setSelectedPeriod,selectedPeriod,historyLoading,priceHistory}) => {
  const periodOptions=[
    {day:1, label:"1G"},
    {day:7, label:"7G"},
    {day:30, label:"30G"},
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex gap-2">
          {periodOptions.map(({day, label})=>(
            <button onClick={()=> setSelectedPeriod(day)} 
